...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content mt-10">
            <div>
                <span className="footer-title text-[#f19b1a]">Services</span> 
            ...
            <div>
                <span className="footer-title text-[#f19b1a]">Company</span> 
            ...
            <div>
                <span className="footer-title text-[#f19b1a]">Legal</span> 
